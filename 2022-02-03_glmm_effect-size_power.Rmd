...
The direction is negative, meaning that the accuracy at severe noise condition tends to be higher than at mild noise condition. Remember that this was not intended, as the data comes from a random distribution without higher weight given to any of these two noise conditions.
...
Current sample size, in this pilot study (the fake data), is 26. We want to find out what the power is when the increased sample sizes in the real experiment range from 32 to 160. We will test for five different sample sizes (32, 6, 96, 128, and 160). I selected these numbers randomly here.
...
-   Check [Green and MacLeod (2015)](https://doi.org/10.1111/2041-210X.12504) for a better and elaborate discussion about `simr` package for power estimation and sample size calculation.

-   There are other resources which I have followed, but I don't remember them right now. I'll add them in references soon. Apologies to the authors!
